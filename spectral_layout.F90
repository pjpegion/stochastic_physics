...
!
! 20190503   dom heinzeller : stochy_la2ga; todo: cleanup nodes, me, ... (defined multiple times in several files)
!
   integer :: nodes,             &
              me,                &
              lon_dim_a,         &
...
!
!$omp parallel private(j,j1,j2,jq,ix,jy,nx,kxs,kxt)                   &
